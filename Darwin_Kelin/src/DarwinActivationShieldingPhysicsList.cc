...
DarwinActivationShieldingPhysicsList::DarwinActivationShieldingPhysicsList():G4VModularPhysicsList()
{
    verboseLevel = 0;
    //Loss table
...
DarwinActivationShieldingPhysicsList::~DarwinActivationShieldingPhysicsList(){}