...
int main(int argc, char** argv)
{
    ...
    G4String shielding_material_name = "Air";
    G4double shielding_thickness = 10.*mm;
    G4double gen_radius = 0.35*m;
    G4double gen_z = 1.01*m;
    G4String file_output = "../results/Air_10.dat";
    int test_number = 1644751
;
    G4String surface = "Cylinder";
    G4int counts = 0;
    G4String info_string = "Processing Running.....\nTotal Simulated Time is 2 Years\nCurrently Running Air 10.*mm in the 1 Years\nPresent Time Cost is 00:00:00\nEstimated Remaining Time is 03:48:00\n";
