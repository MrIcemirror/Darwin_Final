#ifndef Darwin_PS_Generator_Cylinder_HH
#define Darwin_PS_Generator_Cylinder_HH
...
class Darwin_PS_Generator_Cylinder:
    public G4VUserPrimaryGeneratorAction
{
    ...
    private:
        ...
        //Cylinder Surface Generation
        //here z0 is half length of the pipe
        void Cylinder(G4double &x, G4double &y, G4double &z, G4double R, G4double z0);
